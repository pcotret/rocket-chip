...
object Instructions {
  ...
  def LBR = BitPat("b?????????????????000?????0011111")
  def LH                 = BitPat("b?????????????????001?????0000011")
  def LHR = BitPat("b?????????????????001?????0011111")
  def LW                 = BitPat("b?????????????????010?????0000011")
  def LWR = BitPat("b?????????????????010?????0011111")
  def LD                 = BitPat("b?????????????????011?????0000011")
  def LDR = BitPat("b?????????????????011?????0011111")
  def LBU                = BitPat("b?????????????????100?????0000011")
  def LBUR = BitPat("b?????????????????100?????0011111")
  def LHU                = BitPat("b?????????????????101?????0000011")
  def LHUR = BitPat("b?????????????????101?????0011111")
  def LWU                = BitPat("b?????????????????110?????0000011")
  def LWUR = BitPat("b?????????????????110?????0011111")
  def SB                 = BitPat("b?????????????????000?????0100011")
  def SBR = BitPat("b?????????????????000?????0111111")
  def SH                 = BitPat("b?????????????????001?????0100011")
  def SHR = BitPat("b?????????????????001?????0111111")
  def SW                 = BitPat("b?????????????????010?????0100011")
  def SWR = BitPat("b?????????????????010?????0111111")
  def SD                 = BitPat("b?????????????????011?????0100011")
  def SDR = BitPat("b?????????????????011?????0111111")

...
object Instructions {
  /* RIMI-specific instructions */
  def LB1                = BitPat("b?????????????????000?????0011111")
  def LBU1               = BitPat("b?????????????????100?????0011111")
  def LH1                = BitPat("b?????????????????001?????0011111")
  def LHU1               = BitPat("b?????????????????101?????0011111")
  def LW1                = BitPat("b?????????????????010?????0011111")
  def LWU1               = BitPat("b?????????????????110?????0011111")
  def LD1                = BitPat("b?????????????????011?????0011111")
  def SB1                = BitPat("b?????????????????000?????0111111")
  def SH1                = BitPat("b?????????????????001?????0111111")
  def SW1                = BitPat("b?????????????????010?????0111111")
  def SD1                = BitPat("b?????????????????011?????0111111")
  def CHDOM              = BitPat("b?????????????????000?????1110111")
  def RETDOM             = BitPat("b?????????????????000?????1111111")
  def SS                 = BitPat("b?????????????????111?????0111111")
  def LS                 = BitPat("b?????????????????111?????0011111")
